...
exec_name = {
    '1_union': ['main.cpp', 'union'],
    '2_kth_element': ['main.cpp', 'kth_element'],
    '3_memory_allocator': ['main.cpp', 'memory_allocator']
}
...
if __name__ == '__main__':
    ...
    if args.task == '2_kth_element':
        compile_cmd.insert(2, os.path.join(args.source_dir, 'link.cpp'))
